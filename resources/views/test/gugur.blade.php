    ...
    <table style="border-collapse: collapse; width: 99.1206%; height: 71px;" border="1">
        ...
        <tr>
            <td style="width: 20%;" colspan="3">
                <textarea class="form-control" name="sasaran1" value="" readonly >{{$data['sasaran']}}</textarea>
            </td>
        </tr>
            ...
            <tr style="height: 18px;">
                ...
                <td style="width: 20%; height: 18px; text-align: center;"><input class="form-control" name="pencapaian_2" type="number" value="{{$data['pencapaian_1']}}" readonly /></td>
