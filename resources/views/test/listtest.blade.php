  ...
  <tbody>
    <tr>
        ...
        <td style="text-align:right;">
            ...
            <p align="center"><a class="btn btn-success text-light btn-sm"  data-toggle="modal" id="mediumButtonAkhir" data-target="#mediumModalAkhir" data-attr="{{ route('create.test3', $test->id) }}" title="Tambah"><i class="fa fa-plus" style="color:black"> Tambah</i></a></p>
            @else
            @endif
        </td>
        <!-- Table Children -->
