  ...
  <tbody>
    <tr>
        ...
        <td style="text-align:right;">
            ...
            <a class="btn btn-success text-light btn-sm"  data-toggle="modal" id="mediumButtonAkhir" data-target="#mediumModalAkhir" data-attr="{{ route('create.test3', $test->id) }}" title="Tambah"><p align="center"><i class="fa fa-plus" style="color:black"> Tambah</i></p></a>
            @else
            @endif
        </td>
        <!-- Table Children -->
