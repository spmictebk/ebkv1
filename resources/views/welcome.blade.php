    ...
    <body class="antialiased">
            @if (Route::has('login'))
                <div class="hidden fixed top-0 right-0 px-6 py-4 sm:block">
                    ...
                    @else
                        <a href="{{ route('login') }}" class="text-sm text-black-700 dark:text-gray-500">LOG MASUK</a>

                        @if (Route::has('register'))
                            <a href="{{ route('register') }}" class="ml-4 text-sm text-black-700 dark:text-gray-500">DAFTAR AKAUN</a>
                        @endif
                    @endauth
                </div>
            @endif
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2">
                        <div class="p-6">
                            <div class="flex items-center">
                                ...
                                <p align=justify><div class="ml-4 text-lg leading-7 font-semibold"><a class="text-gray-900 dark:text-white">Sistem e-Keberhasilan atau eBK dibangunkan bertujuan untuk :</a></div>
                            </div>
